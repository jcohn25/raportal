 ...
 * 
 * Edited May 12, 2012 by
 * Kenner Estes (kenner+superbox@gmail.com)
 *
 * TODO :
...
;(function($){
	...
	defaultSettings = {
		...
		boxWidth: "600",
		boxHeight: "400",
		loadTxt: 'Loading...<br /><br /><img src="' + imgBaseUrl + '/working.gif" />',
		closeTxt: "Close",
		prevTxt: "Previous",
		nextTxt: "Next",
		beforeShow: function(){}
	...
	$.extend($.superbox, {
		...
		image: function($elt, curSettings, type){
			...
			$elt.click(function(e){
				if (!e.disabled) {    // test wrapper added by Kenner Estes, May 12, 2012
					e.preventDefault();
		...
		iframe: function($elt, curSettings){
			...
			// On click event
			$elt.click(function(e){
				if (!this.disabled) { // test wrapper added by Kenner Estes
					e.preventDefault();
